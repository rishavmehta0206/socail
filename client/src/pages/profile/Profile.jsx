...
export default function Profile() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8800/api/user?username=${username}`)
  ...
  const handlePhotoUpload = async (e) => {
    ...
    try {
      let {data} = await axios.put(`http://localhost:8800/api/user/${loggedInUser?._id}`, apiBody);
          ...
          <div className="profileRightTop">
            <div className="profileCover">
              <img
                ...
                src="http://localhost:8800/images/noCover.png"
                alt=""
              />
              {/* <div className="">
                <input
