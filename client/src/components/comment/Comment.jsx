...
function Comm({ comment, level, addComment, dispatch }) {
  ...
  function likeComment(commentId) {
    axios
      .put("http://localhost:8800/api/comment/like-comment/" + commentId, {
        ...
        >
          ...
          >
            <div style={{
              ...
              <img src={"http://localhost:8800/images/like.png"}
...
function Input({ query, setQuery, addComment, commentId }) {
  return (
    <div
      style={{
